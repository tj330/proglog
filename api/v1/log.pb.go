...
const file_api_v1_log_proto_rawDesc = "" +
	...
	"\x06record\x18\x02 \x01(\v2\x0e.log.v1.RecordR\x06record\"\x12\n" +
	"\x10GetServerRequest\"=\n" +
	...
	"\tis_leader\x18\x03 \x01(\bR\bisLeader2\xd4\x02\n" +
	"\x03Log\x12<\n" +
	...
	"\rProduceStream\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse\"\x00(\x010\x01\x12C\n" +
	"\n" +
	"GetServers\x12\x18.log.v1.GetServerRequest\x1a\x19.log.v1.GetServerResponse\"\x00B%Z#github.com/tj330/proglog/api/log_v1b\x06proto3"
