...
func TestResolver(t *testing.T) {
	...
	srv, err := server.NewGRPCServer(&server.Config{GetServerer: &getServers{}}, grpc.Creds(serverCredentials))
	require.NoError(t, err)
	...
	clientCredentials := credentials.NewTLS(tlsConfig)
	opts := resolver.BuildOptions{
		DialCreds: clientCredentials,
	}
