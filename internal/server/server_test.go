...
import (
	...
	auth "github.com/tj330/proglog/internal/auth"
...
func TestServer(t *testing.T) {
	for scenario, fn := range map[string]func(
		...
		"produce/consume message to/from the log succeeds": testProduceConsume,
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	dir, err := os.MkdirTemp("/tmp/", "server-test")
	require.NoError(t, err)
	...
	if *debug {
		metricsLogFile, err := os.CreateTemp("/tmp", "metrics-*.log")
		require.NoError(t, err)
		t.Logf("metrics log file: %s", metricsLogFile.Name())
		tracesLogFile, err := os.CreateTemp("/tmp", "traces-*.log")
		require.NoError(t, err)
